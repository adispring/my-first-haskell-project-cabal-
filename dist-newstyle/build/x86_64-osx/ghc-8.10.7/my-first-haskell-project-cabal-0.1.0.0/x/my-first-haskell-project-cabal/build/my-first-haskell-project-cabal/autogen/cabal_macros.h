...
/* package my-first-haskell-project-cabal-0.1.0.0 */
#ifndef VERSION_my_first_haskell_project_cabal
#define VERSION_my_first_haskell_project_cabal "0.1.0.0"
#endif /* VERSION_my_first_haskell_project_cabal */
#ifndef MIN_VERSION_my_first_haskell_project_cabal
#define MIN_VERSION_my_first_haskell_project_cabal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_my_first_haskell_project_cabal */
...
#define CURRENT_COMPONENT_ID "my-first-haskell-project-cabal-0.1.0.0-inplace-my-first-haskell-project-cabal"
